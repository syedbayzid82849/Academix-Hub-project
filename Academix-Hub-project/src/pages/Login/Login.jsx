...
const Login = () => {
    ...
    const handleLogin = (event) => {
        ...
        // loginUserWithEP#
        loginUserWithEP(email, password)
            .then((result) => {
                console.log(result);
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen px-3 md:px-10 gap-5  ">
            <HelmetProvider>
                <title>Login | Academix Hub</title>
            </HelmetProvider>
            <div className="w-full mx-auto mt-5 max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="email" name="email" id="email" placeholder="Email" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 border-1 border-gray-700" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label htmlFor="password" className="block dark:text-gray-600">Password</label>
                        <input type="password" name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 border-1 border-gray-700" />
                        <div className="flex justify-end text-xs dark:text-gray-600">
                            <a rel="noopener noreferrer" href="#">Forgot Password?</a>
                        </div>
                    </div>
                    <input type="submit" className="w-full px-8 py-3 font-semibold rounded-full dark:bg-blue-800 dark:text-gray-100" value="Login Here" />
                </form>
